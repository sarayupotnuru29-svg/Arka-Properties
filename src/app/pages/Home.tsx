...
// Import the founder image from your local assets
// Update 'founder.jpg' to the actual name of your image file
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-4">
                  ...
                  <div className="relative rounded-2xl overflow-hidden shadow-xl h-64 group">
                    <img
                      src={founderImg}
                      alt="Founder of Arka Property"
                      className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105"
                    />
                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
                      <p className="text-white font-bold text-sm">Our Founder</p>
                    </div>
                  </div>
                  <div className="relative rounded-2xl overflow-hidden shadow-xl h-80">
                    <img
